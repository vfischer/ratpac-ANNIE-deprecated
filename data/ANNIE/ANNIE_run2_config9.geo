...
// 
// Config 9: - 20 LUX 10inch PMTs at bottom (long bases)
//	     - 45 10inch Watchboy, 30 10inch HQE
//           - 22 11 inch ETEL PMT on top
//
...
//  2018-02-27 : Config 9 (45 Watchboy r7081 + 30 new r7081 hqe on side) added
////////////////////////////////////////////////////////
...
pos_table: "PMTINFO_config9_bottomgrid", //generated on the fly
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config9_topgrid", //generated on the fly
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config9_side_ring_1", //generated on the fly
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config9_side_ring_2", //generated on the fly
// start_idx: 70, //index of first inner pmt
// end_idx: 79, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, -560.1],
// orient_point: [0.0, 0.0, -133.3], 
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config9_side_ring_3", //generated on the fly
// start_idx: 80, //index of first inner pmt
// end_idx: 89, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, -50.8],
// orient_point: [0.0, 0.0, -133.3],   
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config9_side_ring_4", //generated on the fly
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config9_side_ring_5", //generated on the fly
