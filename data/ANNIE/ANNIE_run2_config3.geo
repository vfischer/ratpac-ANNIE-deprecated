...
//	     - 9 rows 12 PMTs on the sides (45 10inch HQE Watchboy, 60 8inch SK)
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_1", //generated on the fly
// start_idx: 60, //index of first inner pmt
// end_idx: 69, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, -1211.5],
...
mother: "detector", 
type: "pmtarray", 
pmt_model: "r7081_hqe", // Watchboy 10 inch
pmt_detector_type: "idpmt",
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_2", //generated on the fly
// start_idx: 70, //index of first inner pmt
// end_idx: 79, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, -875.3],
// orient_point: [0.0, 0.0, -133.3], 
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_3", //generated on the fly
// start_idx: 80, //index of first inner pmt
// end_idx: 89, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, -539.1],
// orient_point: [0.0, 0.0, -133.3],   
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_4", //generated on the fly
// start_idx: 90, //index of first inner pmt
// end_idx: 99, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, -202.9],
// orient_point: [0.0, 0.0, -133.3],  
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_5", //generated on the fly
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_6", //generated on the fly
// start_idx: 100, //index of first inner pmt
// end_idx: 109, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, 469.5],
// orient_point: [0.0, 0.0, -133.3],  
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_7", //generated on the fly
// start_idx: 100, //index of first inner pmt
// end_idx: 109, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, 805.7],
// orient_point: [0.0, 0.0, -133.3],  
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_8", //generated on the fly
// start_idx: 100, //index of first inner pmt
// end_idx: 109, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, 1141.9],
// orient_point: [0.0, 0.0, -133.3],  
} 
...
sensitive_detector: "/mydet/pmt/inner", 
efficiency_correction: 1.000,  
pos_table: "PMTINFO_config3_side_ring_9", //generated on the fly
// start_idx: 100, //index of first inner pmt
// end_idx: 109, //index of last inner pmt
orientation: "point",
orient_point: [0.0, 0.0, 1478.11],
// orient_point: [0.0, 0.0, -133.3],  
} 
