/**
 * @class DS::LAPPDInfo
 * Data Structure: LAPPD properties
 *
 * Information about LAPPDs, including positions, rotations, and types
 */

#ifndef __RAT_DS_LAPPDInfo__
#define __RAT_DS_LAPPDInfo__
...
class LAPPDInfo : public TObject {
public:
  LAPPDInfo() : TObject() {}
  virtual ~LAPPDInfo() {}

  virtual void AddLAPPD(const TVector3& _pos,
                      const TVector3& _dir,
                      const int _type,
  ...
  virtual void AddLAPPD(const TVector3& _pos,
                      const TVector3& _dir,
                      const int _type) {
    AddLAPPD(_pos,_dir,_type,"");                   
  }

  virtual Int_t GetLAPPDCount() const { return pos.size(); }
